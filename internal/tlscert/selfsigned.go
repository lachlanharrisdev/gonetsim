...
// SelfSignedOptions tunes certificate generation.
...
// GenerateSelfSigned returns an ephemeral certificate with a discarded CA.
...
// GenerateSelfSignedWithCA builds a fresh CA and a server leaf signed by it.
// certPEM is leaf+CA so servers can present the chain; caPEM is the standalone
// CA for clients that need to trust it.
