...
var docsCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Print("This documentation includes in-depth guides, references for services & detailed specifications\n\n")
		fmt.Println("The official repository is located at https://github.com/lachlanharrisdev/gonetsim")
		fmt.Print("This is the source for issue tracking, discussions, downloads and contribution guidelines\n\n")
	},
